-- ============================================================
-- RESIAR v72 - cierre de lectura directa del banco de preguntas
-- Objetivo:
--   - El cliente ya no debe leer public.preguntas directamente.
--   - El catálogo visible viaja por RPC sanitizado, solo con metadatos.
--   - Las sesiones seguras vuelven a validar acceso por plan en backend.
--   - La respuesta correcta nunca viaja antes de responder.
--   - Se revocan permisos directos sobre public.preguntas a anon/authenticated.
-- ============================================================
